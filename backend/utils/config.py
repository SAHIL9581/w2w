...
# --- THIS IS THE FIX ---
# Restored the simple list of rotating colors as requested.
LOG_PLOT_COLORS = ['red', 'black', 'blue']
# --- END OF FIX ---

# The fallback mapping for non-standard curve names remains the same.
CLIENT_MAPPING = {
    "RDEP": "RES", "RMED": "SN18", "RSHA": "IND", "SP": "SP",
    "GR": "None", "SGR": "None", "RXO": "None", "RMIC": "None", "DTC": "None",
    "DTS": "None", "RHOB": "None", "DRHO": "None", "NPHI": "None", "PEF": "None",
    "CALI": "None", "BS": "None", "DCAL": "None", "ROP": "None", "ROPA": "None",
    "MUDWEIGHT": "None",
}